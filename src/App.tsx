...
export default function App() {
    return (
        <div className="px-12 py-6 print:p-0 font-noto text-sm h-screen flex flex-col gap-4">
            ...
            <div>
                ...
                <div className="flex flex-col divide-y divide-zinc-300">
                    ...
                    >
                        Jag började som lärling och fick snabbt ansvar för att
                        självständigt utveckla en intern dashboard för koncernen
                        tillsammans med en projektledare. Gick därefter vidare
                        till att utveckla och underhålla ett av koncernens
                        företags hemsida, både frontend (UI/UX), backend (API:er
                        och databas) samt visualisering av intern statistik.
                    </Experience>
                    <Experience
                        className="py-4"
                    ...
                    >
                        ...
                        utökat ansvar för beställningar och löpande uppföljning
                        av sortimentet, i nära dialog med butikschef och
                        kollegor för att säkerställa tillgänglighet
                    </Experience>
                    <Experience
                        className="py-4"
                        ...
                        to={new Date("2021-08")}
                    >
                        Arbetsuppgifterna innebar att vara ett dagligt stöd i
                        brukarens vardag, inklusive personlig omvårdnad,
                        medicinering, kommunikation och hjälp vid aktiviteter i
                        och utanför hemmet.
                    </Experience>
                </div>
            </div>
            <div>
                <h2 className="text-base font-semibold mb-2">Annan kunskap</h2>
